        ...
        return (
            <div className='container'>
                ...
                <div className='center'>
                    <img src='./jandjphoto/assets/images/carnation.jpg' height='100px' width='100px' ></img>
                </div>
                ...
                <Row>
                    <Col sm='4'>
                        <Card>
                            <CardImg top width="100%" height='250px' src="./jandjphoto/assets/images/engagement1.jpeg" />
                            <CardBody>
                    ...
                    <Col sm='4'>
                        <Card>
                            <CardImg top width="100%" height='250px' src="./jandjphoto/assets/images/wedding1.jpg" />
                            <CardBody>
                    ...
                    <Col sm='4'>
                        <Card>
                            <CardImg top width="100%" height='250px'  src="./jandjphoto/assets/images/boudoir2.jpg" />
                            <CardBody>
